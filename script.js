...
// Shop Functions
function openShop() {
  // Option 1: Öffne in neuem Tab
  window.open("https://example-shop.com", "_blank")

  // Option 2: Öffne im gleichen Tab (auskommentiert)
  // window.location.href = 'https://example-shop.com';

  // Option 3: Für lokale Shop-Seite (auskommentiert)
